...
abstract: |
  Construímos un código para los registros, tablas de contingencia básicas para las preguntas del Censo del 2017 y aplicaciones en unas comunas. Se generan tablas completas en formato xlsx que quedan en [github](https://github.com/Sud-Austral/ds_censo_verdadero/tree/main/tablas_2017_personas). Tablas parciales idénticas a las generadas son expuestas para corroborar su corrección.
...
```{r}
saveRDS(x, "../ds_corr_censo_casen/censo_personas_con_clave_17.rds")
```
...
write.table(tabla_P17,"tabla.txt", col.name = NA)
...
write_xlsx(tabla, "tablas_2017_personas/tabla_P17.xlsx")
...
colnames(tabla_P18) <- c( "No aplica","Missing", "Agricultura, ganadería, silvicultura y pesca","Explotación de minas y canteras","Industrias manufactureras","Suministro de electricidad, gas, vapor y aire
...
extraterritoriales","Rama no declarada")

write.table(tabla_P18,"tabla.txt", col.name = NA)
tabla <- read.table("tabla.txt")
tabla_names <- tabla[1,]
colnames(tabla) <- tabla_names
tabla <- tabla[-1,]
...
write_xlsx(tabla, "tablas_2017_personas/tabla_P18.xlsx")
...
write.table(tabla_P19,"tabla.txt", col.name = NA)
tabla <- read.table("tabla.txt")
tabla_names <- tabla[1,]
colnames(tabla) <- tabla_names
tabla <- tabla[-1,]
...
write_xlsx(tabla, "tablas_2017_personas/tabla_P19.xlsx")
...
write.table(tabla_P20,"tabla.txt", col.name = NA)
tabla <- read.table("tabla.txt")
tabla_names <- tabla[1,]
colnames(tabla) <- tabla_names
tabla <- tabla[-1,]
...
write_xlsx(tabla, "tablas_2017_personas/tabla_P20.xlsx")
...
write.table(tabla_P21M,"tabla.txt", col.name = NA)
tabla <- read.table("tabla.txt")
tabla_names <- tabla[1,]
colnames(tabla) <- tabla_names
tabla <- tabla[-1,]
...
write_xlsx(tabla, "tablas_2017_personas/tabla_P21M.xlsx")
...
write.table(tabla_P21A,"tabla.txt", col.name = NA)
tabla <- read.table("tabla.txt")
tabla_names <- tabla[1,]
colnames(tabla) <- tabla_names
tabla <- tabla[-1,]
...
write_xlsx(tabla, "tablas_2017_personas/tabla_P21A.xlsx")
...
colnames(tabla_P10PAIS_GRUPO) <- c(
"África","Sudamérica","Oceanía","Centroamérica","Norteamérica","Caribe","Argentina","Bolivia (Estado Plurinacional de)","Asia", "Europa","Colombia","Ecuador","Haití", "Perú", "Venezuela (República Bolivariana de)", "País no declarado", "No aplica","Missing")


write.table(tabla_P10PAIS_GRUPO,"tabla.txt", col.name = NA)
tabla <- read.table("tabla.txt")
tabla_names <- tabla[1,]
colnames(tabla) <- tabla_names
tabla <- tabla[-1,]
...
write_xlsx(tabla, "tablas_2017_personas/tabla_P10PAIS_GRUPO.xlsx")
...
colnames(tabla_P11PAIS_GRUPO) <- c(
...
write.table(tabla_P11PAIS_GRUPO,"tabla.txt", col.name = NA)
tabla <- read.table("tabla.txt")
tabla_names <- tabla[1,]
colnames(tabla) <- tabla_names
tabla <- tabla[-1,]
...
write_xlsx(tabla, "tablas_2017_personas/tabla_P11PAIS_GRUPO.xlsx")
...
colnames(tabla_P12PAIS_GRUPO) <- c(
"África","Sudamérica","Oceanía","Centroamérica","Norteamérica","Caribe","Argentina","Bolivia (Estado Plurinacional de)","Asia", "Europa","Colombia","Ecuador","Haití", "Perú", "Venezuela (República Bolivariana de)", "País no declarado", "No aplica","Missing")


write.table(tabla_P12PAIS_GRUPO,"tabla.txt", col.name = NA)
tabla <- read.table("tabla.txt")
tabla_names <- tabla[1,]
colnames(tabla) <- tabla_names
tabla <- tabla[-1,]
...
write_xlsx(tabla, "tablas_2017_personas/tabla_P12PAIS_GRUPO.xlsx")
...
write.table(tabla_ESCOLARIDAD,"tabla.txt", col.name = NA)
tabla <- read.table("tabla.txt")
tabla_names <- tabla[1,]
colnames(tabla) <- tabla_names
tabla <- tabla[-1,]
...
write_xlsx(tabla, "tablas_2017_personas/tabla_ESCOLARIDAD.xlsx")
...
write.table(tabla_P16A_GRUPO,"tabla.txt", col.name = NA)
tabla <- read.table("tabla.txt")
tabla_names <- tabla[1,]
colnames(tabla) <- tabla_names
tabla <- tabla[-1,]
...
write_xlsx(tabla, "tablas_2017_personas/tabla_P16A_GRUPO.xlsx")
...
write.table(tabla_REGION_15R,"tabla.txt", col.name = NA)
tabla <- read.table("tabla.txt")
tabla_names <- tabla[1,]
colnames(tabla) <- tabla_names
tabla <- tabla[-1,]
...
write_xlsx(tabla, "tablas_2017_personas/tabla_REGION_15R.xlsx")
...
write.table(tabla_PROVINCIA_15R,"tabla.txt", col.name = NA)
tabla <- read.table("tabla.txt")
tabla_names <- tabla[1,]
colnames(tabla) <- tabla_names
tabla <- tabla[-1,]
...
write_xlsx(tabla, "tablas_2017_personas/tabla_PROVINCIA_15R.xlsx")
...
write.table(tabla_COMUNA_15R,"tabla.txt", col.name = NA)
tabla <- read.table("tabla.txt")
tabla_names <- tabla[1,]
colnames(tabla) <- tabla_names
tabla <- tabla[-1,]
...
write_xlsx(tabla, "tablas_2017_personas/tabla_COMUNA_15R.xlsx")
