...
abstract: |
  Construímos un código para los registros, tablas de contingencia básicas para las preguntas del Censo del 2017 y aplicaciones en unas comunas. Se generan tablas completas en formato xlsx que quedan en github. Tablas parciales idénticas a las generadas son expuestas para corroborar su corrección.
